...
// Add event l
  ...
  faqs.forEach((faq, index) => {
   ...
   // console.log((window.innerWidth-(questionButton.style.width.substring(removePart.length)))+"px")
    ...
    questionButton.style.backgroundColor = "#ffaa33"; // Nice shade of green

    //second-medium
    questionButton.addEventListener('mouseover', () => {
      questionButton.style.backgroundColor = '#ffd766';
    });
    //third-darkest
    questionButton.addEventListener('mousedown', () => {
      questionButton.style.backgroundColor = '#FFCC00';
    });
//last-lightest
    questionButton.addEventListener('mouseout', () => {
      questionButton.style.backgroundColor = '#ffaa33';
    });

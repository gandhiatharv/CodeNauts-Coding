...
// Add event l
  ...
  faqs.forEach((faq, index) => {
   ...
   // console.log((window.innerWidth-(questionButton.style.width.substring(removePart.length)))+"px")
    ...
    questionButton.style.backgroundColor = "#35a37b"; // Nice shade of green

    //second-medium
    questionButton.addEventListener('mouseover', () => {
      questionButton.style.backgroundColor = '#59b392';
    });
    //third-darkest
    questionButton.addEventListener('mousedown', () => {
      questionButton.style.backgroundColor = '#279A27';
    });
//last-lightest
    questionButton.addEventListener('mouseout', () => {
      questionButton.style.backgroundColor = '#35a37b';
    });
